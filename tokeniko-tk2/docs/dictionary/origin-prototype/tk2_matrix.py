...
attribute, meronymy. Weights and on/off switches live in tk2_config.WEIGHTS.
    ...
    python docs/dictionary/origin-prototype/tk2_matrix.py --subset v1 --run r1 --apply
    python docs/dictionary/origin-prototype/tk2_matrix.py --subset v1 --run r2-no-gloss --apply     # after editing WEIGHTS
"""
