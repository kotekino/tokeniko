...
listed in the manifest under `added_words`. Declared, never smuggled.
    ...
    python docs/dictionary/origin-prototype/tk2_build2.py                 # report only
    python docs/dictionary/origin-prototype/tk2_build2.py --apply         # write both matrices + the manifest
"""
