...
rather than assumed.
    ...
    python docs/dictionary/origin-prototype/tk2_subset.py --apply         # also write the chosen subset to the sandbox
    python docs/dictionary/origin-prototype/tk2_subset.py --senses all    # denser definitions
"""
