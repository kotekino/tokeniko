...
PCA found. `--layout pca` keeps the raw projection, for comparison.
    ...
    python docs/E1-dictionary/origin-prototype/tk2_viz.py                      # -> docs/E1-dictionary/origin-prototype/out/base_map.html
    python docs/E1-dictionary/origin-prototype/tk2_viz.py --layout pca         # the flat, unrefined projection
    python docs/E1-dictionary/origin-prototype/tk2_viz.py --edge-min 0.9       # only the strongest stated relations
