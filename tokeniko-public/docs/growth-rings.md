...
> Hunch 12 (`tokeniko-tk1/docs/ref/captain-hunches.md`), promoted to the core roadmap's
...
Sources of truth for the *facts*: `tokeniko-tk1/docs/landed.md` (history) and `tokeniko-tk1/docs/roadmap.md`
