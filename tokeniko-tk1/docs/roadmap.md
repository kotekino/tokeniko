...
> **v2 is not tracked here.** The next architecture has its own project and its own status trio:
> `../../tokeniko-tk2/docs/` (`plan.md` · `roadmap.md` · `landed.md`). That boundary is absolute.
