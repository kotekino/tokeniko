...
# writer tools/extract_sufficiency.py call the SAME function, so ruler and writer can never
...
#
#   python tools/probe_sufficiency.py            # full census + samples + the teaser
# ------------------------------------------------------------------------------------------------
import os
import sys
