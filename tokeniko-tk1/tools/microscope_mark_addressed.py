#!/usr/bin/env python
# --------------------------------------------------------------
# tools/microscope_mark_addressed.py — microscope triage bookkeeping (2026-07-17, author's ask).
#
...
#   python tools/microscope_mark_addressed.py           # dry-run: counts only
#   python tools/microscope_mark_addressed.py --apply
# --------------------------------------------------------------
import os
import sys
