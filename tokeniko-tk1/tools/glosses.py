...
#
# Usage:
#   python tools/glosses.py sample [N]   # DRY: compile + show routing for N passing senses, NO writes
#   python tools/glosses.py [LIMIT]      # REAL: store via the services, resumable (skips existing)
# ------------------------------------------------------------------------------------------------
import os
import re
import sys
