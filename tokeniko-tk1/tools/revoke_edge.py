...
#
#   python tools/revoke_edge.py air.n.01 mixture.n.01            # dry-run
#   python tools/revoke_edge.py air.n.01 mixture.n.01 --apply     # retract
# ------------------------------------------------------------------------------------------------
import os
import sys
import time
...
def main():
    ...
    if len(args) != 2:
        print("usage: python tools/revoke_edge.py <subject_sense> <object_sense> [--apply]")
        return
    subject, object = args
