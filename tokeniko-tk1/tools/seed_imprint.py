...
#
#   python tools/seed_imprint.py                    # DRY-RUN: compile-preview each (no writes)
#   python tools/seed_imprint.py --reset --apply    # CLEAR axioms + theorems, then insert (operator-gated)
#   python tools/seed_imprint.py --apply            # insert only (keep existing axioms/theorems)
#
