...
#   python tools/wonder_cogito.py            # DRY-RUN: derive + render + show the conclusion key
#   python tools/wonder_cogito.py --apply    # materialize the theorem (idempotent: semantic dedup)
# ------------------------------------------------------------------------------------------------
import os
import sys
