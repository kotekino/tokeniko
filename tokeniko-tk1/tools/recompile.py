...
#   python tools/recompile.py --collection axioms --limit 8            # DRY-RUN sample
#   python tools/recompile.py                                          # DRY-RUN all collections
#   python tools/recompile.py --apply --collection definitions         # APPLY to definitions
#
# Run with the project venv from the repo root:
#   /Users/renzosala/Develop/personal/tokeniko/.venv/bin/python tools/recompile.py [args]
# ------------------------------------------------------------------------------------------------
import os
import sys
import argparse
