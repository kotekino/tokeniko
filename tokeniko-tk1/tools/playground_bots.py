#!/usr/bin/env python
# --------------------------------------------------------------
# tools/playground_bots.py — the playground puppeteer (senses C/D live-testing).
#
...
#   python tools/playground_bots.py --list
#   python tools/playground_bots.py john <channel_id> "a cat is an animal"
#   python tools/playground_bots.py hellen <channel_id> "do you exist?" --mention
#   python tools/playground_bots.py john <channel_id> "I disagree" --reply-to <message_id>
