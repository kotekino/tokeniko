...
# Pair with tools/trace_fragility.py to analyze the brain's reaction. See doc/ref/test-feedback.md.
#
#   python tools/fragility_batch.py --list            # print the matrix, inject nothing
#   python tools/fragility_batch.py --wipe            # wipe disposable (memory/ideas/actions)
#   python tools/fragility_batch.py --wipe --inject   # clean sheet then inject (brain must be UP)
#   python tools/fragility_batch.py --inject          # inject only
# ------------------------------------------------------------------------------------------------
