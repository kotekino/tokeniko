...
Calibration under test (rule urges from tools/seed_behavior_rules.py, act threshold 0.5):
...
# the seeded personality rows (mirror tools/seed_behavior_rules.py — the calibration under test)
