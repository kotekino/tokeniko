...
# subclass it fires on). The gate, validated in the step-5.1 dry-run (tools/probe_differentia.py):
...
# Gate policy + 0.3 trust settled with the author on the step-4 dry-run (tools/probe_sufficiency.py,
