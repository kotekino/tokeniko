...
#   python scripts/tk1/seed_self.py            # DRY-RUN: compile-check + show the resolved subject uid
#   python scripts/tk1/seed_self.py --apply    # insert the self-facts as axioms (idempotent)
# ------------------------------------------------------------------------------------------------
import os, sys
