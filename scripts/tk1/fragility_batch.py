...
# Pair with scripts/tk1/trace_fragility.py to analyze the brain's reaction. See doc/ref/test-feedback.md.
#
#   python scripts/tk1/fragility_batch.py --list            # print the matrix, inject nothing
#   python scripts/tk1/fragility_batch.py --wipe            # wipe disposable (memory/ideas/actions)
#   python scripts/tk1/fragility_batch.py --wipe --inject   # clean sheet then inject (brain must be UP)
#   python scripts/tk1/fragility_batch.py --inject          # inject only
# ------------------------------------------------------------------------------------------------
