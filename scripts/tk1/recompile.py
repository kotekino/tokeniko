...
#   python scripts/tk1/recompile.py --collection axioms --limit 8            # DRY-RUN sample
#   python scripts/tk1/recompile.py                                          # DRY-RUN all collections
#   python scripts/tk1/recompile.py --apply --collection definitions         # APPLY to definitions
#
# Run with the project venv from the repo root:
#   /Users/renzosala/Develop/personal/tokeniko/.venv/bin/python scripts/tk1/recompile.py [args]
# ------------------------------------------------------------------------------------------------
import os
import sys
import argparse
