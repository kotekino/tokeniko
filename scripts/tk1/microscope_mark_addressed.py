#!/usr/bin/env python
# --------------------------------------------------------------
# scripts/tk1/microscope_mark_addressed.py — microscope triage bookkeeping (2026-07-17, author's ask).
#
...
#   python scripts/tk1/microscope_mark_addressed.py           # dry-run: counts only
#   python scripts/tk1/microscope_mark_addressed.py --apply
# --------------------------------------------------------------
import os
import sys
