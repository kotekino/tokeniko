...
#
#   python scripts/tk1/seed_imprint.py                    # DRY-RUN: compile-preview each (no writes)
#   python scripts/tk1/seed_imprint.py --reset --apply    # CLEAR axioms + theorems, then insert (operator-gated)
#   python scripts/tk1/seed_imprint.py --apply            # insert only (keep existing axioms/theorems)
#
