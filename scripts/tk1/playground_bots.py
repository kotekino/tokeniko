#!/usr/bin/env python
# --------------------------------------------------------------
# scripts/tk1/playground_bots.py — the playground puppeteer (senses C/D live-testing).
#
...
#   python scripts/tk1/playground_bots.py --list
#   python scripts/tk1/playground_bots.py john <channel_id> "a cat is an animal"
#   python scripts/tk1/playground_bots.py hellen <channel_id> "do you exist?" --mention
#   python scripts/tk1/playground_bots.py john <channel_id> "I disagree" --reply-to <message_id>
