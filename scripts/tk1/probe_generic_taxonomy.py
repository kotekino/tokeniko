...
#
#   python scripts/tk1/probe_generic_taxonomy.py             # parts 1–3 (parser-free, fast)
#   python scripts/tk1/probe_generic_taxonomy.py --compile   # + part 4 (loads the full pipeline)
# ------------------------------------------------------------------------------------------------
import os
import sys
