...
# writer scripts/tk1/extract_sufficiency.py call the SAME function, so ruler and writer can never
...
#
#   python scripts/tk1/probe_sufficiency.py            # full census + samples + the teaser
# ------------------------------------------------------------------------------------------------
import os
import sys
